<?php  
	...
	if($_POST['metodo'] == '1'){
		$sql = "INSERT INTO productos VALUES(null,'$_POST[nombre]','$_POST[ume]','$_POST[categoria]','$_POST[existencia]','$_POST[maximo]','$_POST[minimo]','1','0')";
		...
		if($res=$con->query($sql)){
			if ($res->num_rows > 0) {
				while($row = $res->fetch_assoc()){
					...
					$arreglo['data'][] = array('Nombre'=> $row['Nombre'], 'UME'=> $row['UME'], 'Existencia'=> $row['Existencia'], 'Max'=> $row['Max'], 'Min'=> $row['Min'], 'Activo'=> $activo, 'Botones'=> $bModificar.$bBorrar);	
				}
	...
	if($_POST['metodo'] == '4'){
		$sql = "UPDATE productos SET Nombre='$_POST[nombre]',UME='$_POST[ume]',Existencia='$_POST[existencia]',Max='$_POST[maximo]',Min='$_POST[minimo]',Activo='$_POST[activo]' WHERE ID_Producto='$_POST[id]'";
